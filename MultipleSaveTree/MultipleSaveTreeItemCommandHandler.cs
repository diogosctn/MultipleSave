...
{
    class MultipleSaveTreeItemCommandHandler : SimpleCommandHandler
    {
        public static string ID = "MultipleSave.MultipleSaveTreeItemCommand";
        ...
        {          
            ...
            PetrelLogger.InfoOutputWindow(string.Format("{0} clicked", @"MultipleSaveTreeItem" ));
        }

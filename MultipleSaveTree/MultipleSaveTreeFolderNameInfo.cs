...
namespace  MultipleSave
{
	...
	/// </remarks>
	internal class  MultipleSaveTreeFolderNameInfo : NameInfo
	{
		private  MultipleSaveTreeFolder folder;

		public  MultipleSaveTreeFolderNameInfo( MultipleSaveTreeFolder folder)
		{
		    if (folder != null)
		    {
		        this.folder = folder;
		...
		public override string TypeName
		{
			get
			{
				return folder.GetType().ToString();
			}
		}
	}
}

...
{
    class MultipleSaveNumberTreeItemCommandHandler : SimpleCommandHandler
    {
        public static string ID = "MultipleSave.MultipleSaveNumberTreeItemCommand";
        ...
        {          
            ...
            PetrelLogger.InfoOutputWindow(string.Format("{0} clicked", @"MultipleSaveNumberTreeItem" ));
        }

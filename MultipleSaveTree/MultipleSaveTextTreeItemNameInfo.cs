...
namespace MultipleSave
{
	...
	/// </remarks>
	internal class MultipleSaveTextTreeItemNameInfo : NameInfo
	{
		private MultipleSaveTextTreeItem item;

		public MultipleSaveTextTreeItemNameInfo(MultipleSaveTextTreeItem item)
		{
		    if (item != null)
		    {
		        this.item = item;

...
namespace MultipleSave
{
	...
	/// </remarks>
	internal class MultipleSaveNumberTreeItemNameInfo : NameInfo
	{
		private MultipleSaveNumberTreeItem item;

		public MultipleSaveNumberTreeItemNameInfo(MultipleSaveNumberTreeItem item)
		{
		    if (item != null)
		    {
		        this.item = item;

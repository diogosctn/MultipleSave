...
namespace  MultipleSave
{
	...
	/// Singleton class.
	/// </summary>
	class MultipleSaveNumberTreeItemFactory : INameInfoFactory, IImageInfoFactory
	{
		/// <summary>
		/// Singleton member variable.
		/// </summary>
		private static MultipleSaveNumberTreeItemFactory instance = new MultipleSaveNumberTreeItemFactory();
		/// <summary>
		/// Gets the singleton instance.
		/// </summary>
		public static MultipleSaveNumberTreeItemFactory Instance
		{
			get { return instance; }
		}
		...
		/// </summary>
		private MultipleSaveNumberTreeItemFactory()
		{
		}
